        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {SPEAKERS.map((speaker, index) => (
            <div key={index} className="group relative">
              ...
              <div className="relative bg-slate-900/80 backdrop-blur-sm rounded-2xl p-8 border border-white/10 group-hover:border-brand-neon/50 transition-all duration-300 h-full flex flex-col items-center text-center shadow-xl group-hover:shadow-[0_0_20px_rgba(211, 225, 51,0.15)]">
                <div className="w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-brand-neon/50 group-hover:border-brand-neon mb-6 shadow-[0_0_15px_rgba(211, 225, 51,0.3)] transition-all">
                  <img
                    src={speaker.image}
                    alt={speaker.name}
                ...
                <p className="text-brand-neon font-semibold tracking-wide uppercase text-sm mb-4 drop-shadow-[0_0_5px_rgba(211, 225, 51,0.5)]">{speaker.role}</p>
