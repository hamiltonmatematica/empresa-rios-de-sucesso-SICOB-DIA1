        ...
        <section id="agenda" className="py-20 bg-brand-dark/50 relative">
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-brand-neon font-bold tracking-widest uppercase text-3xl md:text-5xl mb-2 drop-shadow-[0_0_5px_rgba(211, 225, 51,0.5)]">Cronograma Oficial</h2>
                        ...
                        <div className="relative border-l-2 border-brand-neon/20 ml-4 md:ml-0 space-y-8 md:space-y-12">
                            {AGENDA_DAY_1.map((item, index) => (
                                <div key={index} className="relative flex flex-col md:flex-row gap-4 md:gap-8 group">
                                    <div className="absolute -left-[9px] top-0 md:top-2 w-4 h-4 rounded-full bg-slate-900 border-2 border-brand-neon group-hover:bg-brand-neon group-hover:shadow-[0_0_10px_rgba(211, 225, 51,0.8)] transition-all duration-300"></div>
                                    ...
                                    <div className="flex-1 bg-white/[0.03] backdrop-blur-sm p-6 rounded-lg border border-white/10 group-hover:border-brand-neon/50 transition-all duration-300 ml-6 md:ml-0 group-hover:shadow-[0_0_20px_rgba(211, 225, 51,0.05)]">
